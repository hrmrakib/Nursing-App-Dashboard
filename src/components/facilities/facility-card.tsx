...
export default function FacilityCard({
  ...
  return (
    <div className="bg-white rounded-xl p-4 flex items-center gap-4 shadow-sm border border-gray-100 w-full max-w-xl">
      {/* Image */}
        ...
        <div className="flex flex-col gap-1 mt-1 text-sm text-gray-500">
          ...
          {facility.phone && (
            <div className="flex items-center">
              <span className="w-4 h-4 mr-2 text-gray-400 flex justify-center">📞</span>
              <span className="truncate">{facility.phone}</span>
            </div>
          )}
          {facility.email && (
            <div className="flex items-center">
              <span className="w-4 h-4 mr-2 text-gray-400 flex justify-center">✉️</span>
