...
export default function ShiftCard({ shift, onClick }: ShiftCardProps) {
  return (
    ...
    >
      {/* Facility Image */}
      <div className="relative h-40 sm:h-44 bg-gradient-to-br from-blue-50 to-slate-100 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-full h-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 flex items-end justify-center gap-1 px-4">
              {/* Left building */}
              <div className="w-1/4 h-24 bg-gradient-to-b from-sky-300 to-sky-400 rounded-t-sm relative">
              ...
              <div className="w-2/5 h-32 bg-gradient-to-b from-blue-200 to-blue-300 rounded-t-sm relative">
              ...
              {/* Right building */}
              <div className="w-1/4 h-28 bg-gradient-to-b from-slate-200 to-slate-300 rounded-t-sm relative">
                <div className="absolute inset-2 grid grid-cols-3 gap-0.5">
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center gap-1">
          <span className="text-base font-bold text-primary">${shift.payRate}</span>
